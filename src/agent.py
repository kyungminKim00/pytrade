...
if __name__ == "__main__":
    train_agent = Agent(
        raw_filename_min="./dataset/raw/dax_tm3.csv",
        pivot_filename_day="./dataset/intermediate/dax_intermediate_pivots.csv",
        mode="train",
    )
    train_agent.next()
    ...
    # agent.analyse_data_to_csv("./dataset/intermediate/dax_anayse_data.csv")
